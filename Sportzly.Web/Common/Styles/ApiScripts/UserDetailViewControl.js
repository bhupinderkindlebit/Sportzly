...
bindUserDetails = function () {
    ko.applyBindings(userDetailsModel.Result, $('.johnny-streams').get(0));
}
...
showEvent = function () {
    $.colorbox({
        ...
        , onClosed: function () { window.location = "myupdates.aspx"; }
    });
}

showCreateTeam = function () {
    $.colorbox({
        href: "CreateTeam.aspx", iframe: true, height: '690', width: "740", scrolling: false        
    });
}
