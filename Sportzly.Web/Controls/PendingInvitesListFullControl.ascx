<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PendingInvitesListFullControl.ascx.cs" Inherits="Sportzly.Web.Controls.PendingInvitesListFullControl" %>
<style type="text/css">
    .ch {
        float: left;
        margin-left: 22px;
    ...
    <article class="list-img-content-fans">
        ...
        <article style="float: left; margin-left:20px; margin-top: 10px;">
         ...
         <article style="float: right; margin-right:20px; margin-top: 10px;">
            <a href="javascript:;" onclick="sendInvite();">
                <img src="images/send_invite_blue.png" />
            </a>
            <a href="myupdates.aspx" id="anCancel">
                <img src="images/admin_cancel.png" />
            </a>
        </article>
