...
{
    public partial class NewAlbumPhotosListControl : BaseUserControl<NewAlbumPhotosListControl>
    {
        ...
        [UserControlScriptMethod]
        public static ActionResult<UserEmailEntity> GetEmail(string userKey, long ownerId)
        {
            return ApiMethods.GetEmail(userKey,ownerId);
        }
    }
}