...
{
    public partial class PlayersFilterControl : BaseUserControl<PlayersFilterControl>
    {
        ...
        {
            return ApiMethods.SearchPlayers(userKey, email, keyWord, sports, level, location);
        }
    }
}