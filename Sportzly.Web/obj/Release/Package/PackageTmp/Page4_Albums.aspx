<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page4_Albums.aspx.cs" Inherits="Sportzly.Web.Page4_Albums" %>
    ...
    <div class="inner-content-new rightsticky" data-sticky_parent>
      ...
      <section id="containerbar" class="col-xs-7 col-sm-7 col-md-7">
         <ul class="resp-tabs-list">
            ...
            <li class="resp-tab-active"><a href="videos.html"><span class="PHOTOS"></span>Photos / Videos  </a></li>
       ...
       <div class="resp-tabs-container noborder-bottom">
           ...
           <div class="documents-sec col-xs-12 col-sm-12 col-md-12">
              <div class="fontphotobtn2">
                <button type="button" class="btn btn-primary blue fontphoto">Albums (5)</button>
              </div>
              <div class="section-title">
                <h2>PHOTOS <strong>(13)</strong></h2>
              </div>
              <div class="search-sec">
                <div class="documentssearch">
                  <input type="text" name="" class="input" value="" placeholder="Search for photos">
                  <a href="#"><i class="fa fa-fw"></i></a> </div>
                <div class="documentsbtn"> <a class="view-all fancybox" href="#inline2"><i class="fa fa-fw" style="position: relative; top:2px; left: 0px; color:#fff"></i> Photos / Videos </a> </div>
                <div id="inline2" style="max-width:730px;display: none;">
                  <div class="form-row">
                    <h3>ADD PHOTO</h3>
                    <ul>
                      <li>
              ...
              <div class="photo-sec">
                <div class="bx-wrapper">
                  <ul class="bxslider">
                    <li><span class="listimg"><a class="fancybox2" href="images/album1/photo1.jpg" data-fancybox-group="gallery1" title=""><img alt="img" src="images/album-img1.jpg"></a> <a href="#" class="album-text">Album - 1</a> <a class="fancybox2" href="images/album1/photo2.jpg" data-fancybox-group="gallery1" title=""></a> </span> <span class="listimg"><a class="fancybox2" href="images/album2/photo1.jpg" data-fancybox-group="gallery2" title=""><img alt="img" src="images/album-img2.jpg"></a> <a href="#" class="album-text">Album - 2</a> <a class="fancybox2" href="images/album2/photo2.jpg" data-fancybox-group="gallery2" title=""></a> </span> <span class="listimg"><a class="fancybox2" href="images/album3/photo1.jpg" data-fancybox-group="gallery3" title=""><img alt="img" src="images/album-img3.jpg"></a> <a href="#" class="album-text">Album - 2</a> <a class="fancybox2" href="images/album3/photo2.jpg" data-fancybox-group="gallery3" title=""></a> </span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img4.jpg"></a> <a href="#" class="album-text">Album - 4</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img5.jpg"></a> <a href="#" class="album-text">Album - 5</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img1.jpg"></a> <a href="#" class="album-text">Album - 6</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img1.jpg"></a> <a href="#" class="album-text">Album - 7</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img2.jpg"></a> <a href="#" class="album-text">Album - 8</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img4.jpg"></a> <a href="#" class="album-text">Album - 9</a></span> </li>
                    <li><span class="listimg"><a class="" href="#" title=""><img alt="img" src="images/album-img1.jpg"></a> <a href="#" class="album-text">Album - 10</a> <a class="" href="#" title=""></a> </span> <span class="listimg"><a class="" href="#" title=""><img alt="img" src="images/album-img2.jpg"></a> <a href="#" class="album-text">Album - 11</a> <a class="" href="#" title=""></a> </span> <span class="listimg"><a class="" href="#" title=""><img alt="img" src="images/album-img3.jpg"></a> <a href="#" class="album-text">Album - 12</a> <a class="" href="#" title=""></a> </span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img4.jpg"></a> <a href="#" class="album-text">Album - 13</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img5.jpg"></a> <a href="#" class="album-text">Album - 14</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img1.jpg"></a> <a href="#" class="album-text">Album - 15</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img1.jpg"></a> <a href="#" class="album-text">Album - 16</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img2.jpg"></a> <a href="#" class="album-text">Album - 17</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img4.jpg"></a> <a href="#" class="album-text">Album - 18</a></span> </li>
                    <li><span class="listimg"><a class="" href="#" title=""><img alt="img" src="images/album-img1.jpg"></a> <a href="#" class="album-text">Album - 19</a> <a class="" href="#" title=""></a> </span> <span class="listimg"><a class="" href="#" title=""><img alt="img" src="images/album-img2.jpg"></a> <a href="#" class="album-text">Album - 20</a> <a class="" href="#" title=""></a> </span> <span class="listimg"><a class="" href="#" title=""><img alt="img" src="images/album-img3.jpg"></a> <a href="#" class="album-text">Album - 21</a> <a class="" href="#" title=""></a> </span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img4.jpg"></a> <a href="#" class="album-text">Album - 22</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img5.jpg"></a> <a href="#" class="album-text">Album - 23</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img1.jpg"></a> <a href="#" class="album-text">Album - 24</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img1.jpg"></a> <a href="#" class="album-text">Album - 25</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img2.jpg"></a> <a href="#" class="album-text">Album - 26</a></span> <span class="listimg"><a href="#"><img alt="img" src="images/album-img4.jpg"></a> <a href="#" class="album-text">Album - 27</a></span> </li>
                  </ul>
                </div>
              </div>
            </div>
