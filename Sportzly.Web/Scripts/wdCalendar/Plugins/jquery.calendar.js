    ...
    $.fn.bcalendar = function (option) {
                ...
                for (var h = 0; h < l;) {
                    ...
                    if (e) {
                        ...
                        if (!bs && j == (sc - 1) && z[h] < y[h]) {
                            el++;
                            $.extend(tempdata, { "axis": h, ch: "more", "abbr": dateFormat.call(cday[h], i18n.xgcalendar.dateformat.fulldayvalue), html: i18n.xgcalendar.others + i18n.xgcalendar.l + (y[h] - z[h]) + i18n.xgcalendar.r + i18n.xgcalendar.item, click: "javascript:alert('more event');" });
        ...
        function populate() {
            ...
            if (option.url && option.url != "") {
                ...
                { name: "calendartype", value: cType },
                { name: "userKey", value: getUser().UserKey },
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                calbutton.click(function (e) {
                    ...
                    var zone = new Date().getTimezoneOffset() / 60 * -1;
                    var param = [{ "name": "Subject", value: what },
						{ "name": "StartTime", value: datestart },
						{ "name": "EndTime", value: dateend },
