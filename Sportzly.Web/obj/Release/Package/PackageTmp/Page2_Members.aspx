<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page2_Members.aspx.cs" Inherits="Sportzly.Web.Page2_Members" %>
    ...
    <div class="inner-content-new rightsticky" data-sticky_parent>
      ...
      <section id="containerbar" class="col-xs-7 col-sm-7 col-md-7" data-sticky_column>
        <ul class="resp-tabs-list">
            ...
            <li class="resp-tab-active"><a href="members.html"><span class="MEMBERS"></span>MEMBERS</a></li>
               ...
               <div class="col-xs-7 col-sm-7 col-md-7">
                <div class="members-list">
                  <div class="section-title rosterfont">
                    <h2>Roster <strong>(13)</strong></h2>
                  </div>
                  <div class="search-sec">
                    <input type="text" value="" class="input" name="" placeholder="Search for roster">
                    <a href="#"><i class="fa fa-fw"></i></a> </div>
                  <div class="listin-row"> 
                    <!-- <h2 class="Contributors">Top Contributors</h2>-->
                    <ul>
                      <li> <span class="user-img"><img alt="user" src="images/profile-leftbar-img.jpg"></span> <span class="user-namerow"> <a href="#">Johnny Radford </a> 
                        <!--<span class="Comments-row">785 Posts. 478 Comments</span>--> 
                        </span> </li>
                      <li class="lightgre"> <span class="user-img"><img alt="user" src="images/user-001.jpg"></span> <span class="user-namerow"> <a href="#">Joseph Caparelli</a> </span> </li>
                      <li> <span class="user-img"><img alt="user" src="images/profile-leftbar-img.jpg"></span> <span class="user-namerow"> <a href="#">Johnny Radford </a> </span> </li>
                      <li class="lightgre"> <span class="user-img"><img alt="user" src="images/user-001.jpg"></span> <span class="user-namerow"> <a href="#">Joseph Caparelli</a> </span> </li>
                      <li><span class="user-img"><img alt="user" src="images/profile-leftbar-img.jpg"></span> <span class="user-namerow"> <a href="#">Johnny Radford </a> </span> </li>
                      <li class="lightgre"> <span class="user-img"><img alt="user" src="images/user-001.jpg"></span> <span class="user-namerow"> <a href="#">Joseph Caparelli</a> </span> </li>
                      <li> <span class="user-img"><img alt="user" src="images/profile-leftbar-img.jpg"></span> <span class="user-namerow"> <a href="#">Johnny Radford </a> </span> </li>
              ...
              <div class="col-xs-5 col-sm-5 col-md-5 eat-nopadding2">
                <div class="pending-members">
                  <div class="section-title memberstitle">
                    <h2>Pending Members <strong>(3)</strong></h2>
                  </div>
                  <ul>
                    <li><a href="mailto:abc123@yahoo.com"><i class="fa fa-fw"></i> abc123@yahoo.com</a>
                      <button class="btn btn-primary blue" type="button"><span class="prev"></span> Resend </button>
                    </li>
                    <li> <a href="mailto:abc123@yahoo.com"><i class="fa fa-fw"></i> abc123@yahoo.com</a>
                      <button class="btn btn-primary blue" type="button"><span class="prev"></span> Resend </button>
                    </li>
                  ...
                  <div class="invite-team-member">
                    ...
                    <textarea placeholder="Copy and Paste multiple email addresses from any place you have them, dont worry about format we will work it out" rows="3" cols="2"></textarea>
                    <button type="button" class="btn btn-primary blue">SEND INVITE</button>
                  </div>
                  <p class="or"><strong>OR</strong></p>
                  <div class="invite-member">
                    <h3>Invite Members</h3>
                    <ul class="icon-social">
                      <li class="first"><a href="#"><img alt="facebook" src="images/facebook-icon.png"></a></li>
                      <li><a href="#"><img alt="facebook" src="images/twitter-icon.png"></a></li>
                      <li><a href="#"><img alt="facebook" src="images/google-icon.png"></a></li>
                      <li><a href="#"><img alt="facebook" src="images/yahoo-icon.png"></a></li>
                      <li class="last"><a href="#"><img alt="facebook" src="images/email-icon.png"></a></li>
                    </ul>
                    <a class="btn-facebook-share" href="#"></a> <a class="btn-twitter-share" href="#"></a> </div>
                </div>
              </div>
