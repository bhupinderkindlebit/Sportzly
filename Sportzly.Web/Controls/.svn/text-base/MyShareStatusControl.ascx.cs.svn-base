...
{
    public partial class MyShareStatusControl : BaseUserControl<MyShareStatusControl>
    {
        ...
        public static ActionResult<ActivityEntity> ShareUpdate(string userKey, string statusMessage, long teamId, long eventId)
        {
            return ApiMethods.UpdateStatus(userKey, statusMessage, null, teamId, eventId);
        }
