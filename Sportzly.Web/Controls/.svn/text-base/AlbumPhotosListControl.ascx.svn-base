<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AlbumPhotosListControl.ascx.cs" Inherits="Sportzly.Web.Controls.AlbumPhotosListControl" %>
    ...
    <article class="list-img-content-fans">
        <article class="top-list-img-content-fans">
            <div id="wrapper">
                ...
                <a href="#" id="left"><img src="../images/left1.png" /></a>
                <a href="#" id="right"><img src="../images/right1.png" /></a>
            </div>
        </article>
    </article>
