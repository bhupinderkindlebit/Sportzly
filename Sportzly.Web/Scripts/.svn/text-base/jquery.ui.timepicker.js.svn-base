        ...
        _generateHTMLMinutes: function (inst) {
            ...
            //for (row = 1; row <= rows; row++) {
                ...
                //while (minuteCounter < row * minutesPerRow) {
                    ...
                    html += '<td class="ui-timepicker-minute-cell" data-timepicker-instance-id="#' + inst.id.replace(/\\\\/g, "\\") + '" data-minute="0" >' +
	                   '<a class="ui-state-default" >00'+
                    '</a></td>';
                    html += '<td class="ui-timepicker-minute-cell" data-timepicker-instance-id="#' + inst.id.replace(/\\\\/g, "\\") + '" data-minute="30" >' +
