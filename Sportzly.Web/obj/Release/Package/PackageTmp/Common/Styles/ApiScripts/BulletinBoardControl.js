...
showBulletine = function (data) {
    ...
    $.colorbox({
        href: "Bulletin.aspx?msgid=" + msgId + "&teamId=" + teamId + "&ts=" + timestamp + "", iframe: true, height: '490', width: "700", scrolling: false       
...
showPoll = function () {   
    $.colorbox({
        href: "CreatePoll.aspx?" + teamId + "", iframe: true, height: '350', width: "340", scrolling: false       
    });
}
...
showAdmin = function () {
    $.colorbox({
        href: "teammembers.aspx?" + teamId + "", iframe: true, height: '620', width: "400", scrolling: false        
    });
}

showInvite = function () {
    $.colorbox({
        href: "invite.aspx?" + teamId + "", iframe: true, height: '218', width: "700", scrolling: false
    });
}

showPhoto = function () {   
    $.colorbox({
        href: "Photo.aspx?" + teamId + "", iframe: true, height: '489', width: "780", scrolling: false
        , onClosed: function () { window.location = "team.aspx?" + teamId + ""; }
    });
}
...
showDocument = function () {   
    $.colorbox({
        href: "Document.aspx?teamid=" + teamId + "", iframe: true, height: '511', width: "780", scrolling: false
        , onClosed: function () { window.location = "team.aspx?" + teamId + ""; }
    });
}
