<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyInviteControl.ascx.cs" Inherits="Sportzly.Web.Controls.MyInviteControl" %>
<style type="text/css">
    .morecontent span
    {
        display: none;
...
<div id="loader3" class="container-loader">
    <div id="loading3" class="nimble-loader">
        <p class="successMsg" id="successPanel" runat="server" style="padding: 10px 0 0 15px;">
        </p>
        <div class="col-xs-6 col-sm-6 col-md-6" style="width: 65%">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 eat-nopadding2" style="width: 35%">
            <div id="divcontacts" class="invite-member">
                ...
                <a class="btn-facebook-share" style="cursor: pointer; padding-bottom: 35px;" onclick="PublishOnFacebook('Request to Join Team');"></a>
