<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboutUs.aspx.cs" Inherits="Sportzly.Web.AboutUs" %>
            ...
            <div class="Aboutus-area">
                ...
                <div class="Aboutus-area-wrapper" >                  
                  ...
                  <h2>ABOUT US</h2>
                   ...
                   <br />
                  <p > Sportzly helps you create your personalized sports experience online. With Sportzly, it’s easy to find and connect with other sports players
                     and enthusiasts like you. You can also find teams, games, events, sporting activities in your locality.</p>                 
                    <br />
                   <p class="im">  Sportzly provides the tools needed to manage your teams, leagues and games in a professional manner. 
                    It automates and simplifies mundane activities so that you focus on the sport you like.</p>
                        <br /> 
                  
                    Sportzly is always listening. Sportzly appreciates your opinion and feedback. If you have any questions or suggestions please feel
                     free to email  <a href="mailto:support@sportzly.com?Subject=Suggestion">support@sportzly.com</a>. 
